...
#$WDEbloater = "https://freetimetech.com/W11D/Windows11DebloaterWindows11DebloaterV206.zip"
#Invoke-WebRequest -Uri $WDEbloater -OutFile "C:\Setup\Windows11Debloater.zip"
