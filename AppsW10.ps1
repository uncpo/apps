$host.ui.RawUI.WindowTitle = “Instalador Apps Windows 10”
chcp 1252 | Out-Null
...
Start-Process "pwsh.exe" -Wait -WindowStyle Minimized -ArgumentList '-command irm https://github.com/asheroto/winget-install/releases/download/5.0.4/winget-install.ps1 | iex'
